...
from utils.matplot_map import plot_together
...
if __name__ == "__main__":
    ...
    name_classes    = ["background","croplands"]
    #----------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path  = "img/2_ny_0_0.png"
    #-------------------------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "/home/piesat/media/ljh/pycharm_project__ljh/unet-pytorch/img/"
    dir_label_path = "/home/piesat/media/ljh/pycharm_project__ljh/unet-pytorch/Medical_Datasets/Labels/"
    dir_save_path   = "img_out_test/"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(('.bmp', '.dib', '.png', '.jpg', '.jpeg', '.pbm', '.pgm', '.ppm', '.tif', '.tiff')):
                ...
                label_path  = os.path.join(dir_label_path, img_name)
                image       = Image.open(image_path)
                try:
                    label   = Image.open(label_path)
                except FileNotFoundError:
                    label = Image.new("L", (1024, 1024), 8)
                r_image     = unet.detect_image(image)
                if not os.path.exists(dir_save_path):
                    os.makedirs(dir_save_path)
                save_path = os.path.join(dir_save_path, img_name)
                fig = plot_together(image, label, r_image, save_path)
