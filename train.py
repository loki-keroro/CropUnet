...
if __name__ == "__main__":
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(devkit_path, "ImageSets/Segmentation/train.txt"),"r") as f:
    ...
    if True:
        ...
        train_dataset   = UnetDataset(train_lines, input_shape, num_classes, True, devkit_path)
